...
Cette différence de valeurs peut être expliquée par une erreur au niveau de l’adimensionnement ou bien dans les équations que nous avons utilisées ainsi que par une faute cachée dans nos paramètres ou nos constantes. 
\\
En fonction du rayon r, la valeur de $\tau_eff$ semble  
